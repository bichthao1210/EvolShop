					...
					<div class="total_area">
						...
						{{-- 	<a class="btn btn-default update" href="">Update</a> --}}
						 <?php
                            ...
                            ?>
                             <li><a class="btn btn-default check_out" href="{{URL::to('/payment')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                               <?php
                                 }else{
                            ?>
                             <li><a class="btn btn-default check_out" href="{{URL::to('/login-checkout')}}"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                                 <?php }?>
